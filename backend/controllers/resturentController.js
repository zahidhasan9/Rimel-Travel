...
//  const createResturent = async (req, res, next) => {
//   try {
//     // user field JWT middleware থেকে আসবে (req.user.id)
//     const newResturent = new Resturent({
//       ...req.body,
//       user: req.user.id, // এখানে current logged-in user assign করা হচ্ছে
//     });

//     // check existing restaurant by registrationNo
//     const existingRestaurant = await Resturent.findOne({
//       registrationNo: newResturent.registrationNo,
//     });
